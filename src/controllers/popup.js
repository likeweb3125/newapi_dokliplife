		...
		const popupObj = {
			...
			p_one_day:
				popupView.p_one_day === enumConfig.useType.Y[0]
					...
					: popupView.p_one_day ===
					  enumConfig.useType.N[0]
					? enumConfig.useType.N
					: null,
			p_layer_pop:
				popupView.p_layer_pop ===
				enumConfig.popupType.LAYER[0]
					? enumConfig.popupType.LAYER
					: popupView.p_layer_pop ===
					  enumConfig.popupType.POPUP[0]
					? enumConfig.popupType.POPUP
