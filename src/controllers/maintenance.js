...
exports.getMaintenanceBoardCreate = async (req, res, next) => {
	const { category, name, password, subject, company, email, m_tel, m_email, contents, b_file } = req.body;
...
exports.getFileDownload = async (req, res, next) => {
	...
	try {
		...
		const fileUrl = 'https://www.likeweb.co.kr/upload/admin/' + boardFile.b_file;
