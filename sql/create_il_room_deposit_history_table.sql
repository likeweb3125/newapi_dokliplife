...
CREATE TABLE `il_room_deposit_history` (
  ...
  `status` VARCHAR(50) NOT NULL COMMENT '상태 (PENDING: 입금대기, PARTIAL: 부분입금, COMPLETED: 입금완료, RETURN_COMPLETED: 반환완료, DELETED: 삭제됨)',
  `unpaidAmount` INT(11) NULL DEFAULT 0 COMMENT '미납액 (계약 보증금 - 그동안 입금 합계, DEPOSIT 입력 시)',
