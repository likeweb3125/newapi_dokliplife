...
| status         | 방 상태 (RESERVE_PENDING, RESERVED, CONTRACT, OVERDUE, CHECKOUT_CONFIRMED, UNPAID) |
...
| roomStatus  | string            | 아니오 | -     | 방 상태 필터 (RESERVE_PENDING, RESERVED, CONTRACT, OVERDUE, CHECKOUT_CONFIRMED, UNPAID) |
